...
<section id="<?php esc_attr_e( $section_id ); ?>" data-type="banner" data-background="<?php esc_attr_e( $section_background_data ); ?>" data-background-mobile="<?php esc_attr_e( $section_background_mobile_data ); ?>" class="banner-section full-width  <?php esc_attr_e( $section_background_class ); ?>">
