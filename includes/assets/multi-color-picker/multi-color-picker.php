...
class Customize_Multi_Color_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		if ( isset( $this->label ) && '' !== $this->label ) {
			esc_attr( '<span class="customize-control-title">' . sanitize_text_field( $this->label ) . '</span>' );
		}

		if ( isset( $this->description ) && '' !== $this->description ) {
			esc_attr( '<span class="description customize-control-description">' . sanitize_text_field( $this->description ) . '</span>' );
		}
